 ...
 */
declare class RewindFastforwardType extends Enum implements PrimitiveType, Command {

    public static REWIND: RewindFastforwardType;
    public static FASTFORWARD: RewindFastforwardType;
